...
public class ConnectionParameters {
	...
	public static final String projectName = "MansikkaApp"; // <= REPLACE this with the name of your own web app
	public static final String databaseFolder = "databases";
	public static final String databaseName = "Hyvarinen.sqlite"; // <= REPLACE this with the name of your DB file
